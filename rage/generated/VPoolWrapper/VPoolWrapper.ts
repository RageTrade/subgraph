...
export class VPoolWrapper__burnResultWrapperValuesInsideStruct extends ethereum.Tuple {
  get sumAX128(): BigInt {
...
export class VPoolWrapper__burnResult {
  value0: BigInt;
  value1: BigInt;
  value2: VPoolWrapper__burnResultWrapperValuesInsideStruct;
...
export class VPoolWrapper__fpGlobalResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class VPoolWrapper__getExtrapolatedValuesInsideResultWrapperValuesInsideStruct extends ethereum.Tuple {
  get sumAX128(): BigInt {
    return this[0].toBigInt();
  }
...
export class VPoolWrapper__getValuesInsideResultWrapperValuesInsideStruct extends ethereum.Tuple {
  get sumAX128(): BigInt {
    return this[0].toBigInt();
  }
...
export class VPoolWrapper__mintResultWrapperValuesInsideStruct extends ethereum.Tuple {
  get sumAX128(): BigInt {
    return this[0].toBigInt();
  }
...
export class VPoolWrapper__mintResult {
  value0: BigInt;
  value1: BigInt;
  value2: VPoolWrapper__mintResultWrapperValuesInsideStruct;
...
export class VPoolWrapper__swapResult {
  value0: BigInt;
  value1: BigInt;
...
export class VPoolWrapper__swapTokenResult {
  value0: BigInt;
  value1: BigInt;
...
export class VPoolWrapper__ticksExtendedResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class VPoolWrapper extends ethereum.SmartContract {
  static bind(address: Address): VPoolWrapper {
    return new VPoolWrapper("VPoolWrapper", address);
  }
  ...
  burn(
    ...
    return new VPoolWrapper__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toTuple() as VPoolWrapper__burnResultWrapperValuesInsideStruct
    );
  }
  ...
  try_burn(
    ...
    tickUpper: i32,
    liquidity: BigInt
  ): ethereum.CallResult<VPoolWrapper__burnResult> {
    let result = super.tryCall(
      "burn",
      "burn(int24,int24,uint128):(uint256,uint256,(int256,int256,int256,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      new VPoolWrapper__burnResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toTuple() as VPoolWrapper__burnResultWrapperValuesInsideStruct
      )
    );
  }
  ...
  fpGlobal(): VPoolWrapper__fpGlobalResult {
    let result = super.call(
      "fpGlobal",
    ...
    return new VPoolWrapper__fpGlobalResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_fpGlobal(): ethereum.CallResult<VPoolWrapper__fpGlobalResult> {
    let result = super.tryCall(
      "fpGlobal",
      "fpGlobal():(int256,int256,int256,uint48)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VPoolWrapper__fpGlobalResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getExtrapolatedValuesInside(
    tickLower: i32,
    tickUpper: i32
  ): VPoolWrapper__getExtrapolatedValuesInsideResultWrapperValuesInsideStruct {
    let result = super.call(
      "getExtrapolatedValuesInside",
    ...
    return result[0].toTuple() as VPoolWrapper__getExtrapolatedValuesInsideResultWrapperValuesInsideStruct;
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as VPoolWrapper__getExtrapolatedValuesInsideResultWrapperValuesInsideStruct
    );
  }
  ...
  getValuesInside(
    tickLower: i32,
    tickUpper: i32
  ): VPoolWrapper__getValuesInsideResultWrapperValuesInsideStruct {
    let result = super.call(
      "getValuesInside",
    ...
    return result[0].toTuple() as VPoolWrapper__getValuesInsideResultWrapperValuesInsideStruct;
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as VPoolWrapper__getValuesInsideResultWrapperValuesInsideStruct
    );
  }
  ...
  mint(
    ...
    return new VPoolWrapper__mintResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toTuple() as VPoolWrapper__mintResultWrapperValuesInsideStruct
    );
  }
  ...
  try_mint(
    ...
    tickUpper: i32,
    liquidity: BigInt
  ): ethereum.CallResult<VPoolWrapper__mintResult> {
    let result = super.tryCall(
      "mint",
      "mint(int24,int24,uint128):(uint256,uint256,(int256,int256,int256,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VPoolWrapper__mintResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toTuple() as VPoolWrapper__mintResultWrapperValuesInsideStruct
      )
    );
  }
  ...
  swap(
    ...
    return new VPoolWrapper__swapResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swap(
    ...
    amountSpecified: BigInt,
    sqrtPriceLimitX96: BigInt
  ): ethereum.CallResult<VPoolWrapper__swapResult> {
    let result = super.tryCall(
      "swap",
      "swap(bool,int256,uint160):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VPoolWrapper__swapResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  swapToken(
    ...
    return new VPoolWrapper__swapTokenResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swapToken(
    ...
    sqrtPriceLimitX96: BigInt,
    isNotional: boolean
  ): ethereum.CallResult<VPoolWrapper__swapTokenResult> {
    let result = super.tryCall(
      "swapToken",
      "swapToken(int256,uint160,bool):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VPoolWrapper__swapTokenResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  ticksExtended(param0: i32): VPoolWrapper__ticksExtendedResult {
    let result = super.call(
      "ticksExtended",
    ...
    return new VPoolWrapper__ticksExtendedResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_ticksExtended(
    param0: i32
  ): ethereum.CallResult<VPoolWrapper__ticksExtendedResult> {
    let result = super.tryCall(
      "ticksExtended",
      "ticksExtended(int24):(int256,int256,int256,uint256)",
      [ethereum.Value.fromI32(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VPoolWrapper__ticksExtendedResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
